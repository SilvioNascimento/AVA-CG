        ...
        <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.11.174/build/pdf.worker.min.js">
            <div style={{ display: 'flex', height: '150vh' }}>
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className='toolbar-container1' style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: '#d9dfe2', width:'100%'}}>
                        <Toolbar>
                            {(props) => (
                                <div style={{
                                    display: 'flex', 
                    ...
                    <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
                        {sidebarVisible && (
                            ...
                            <div style={{width: '950px',overflow:'auto'}}>
                                <Viewer 
                                    fileUrl="./Introdução aos Conceitos.pdf"
                    ...
                    <div className='Area-btn-SistemasMultimidia1'>
                        ...
                        <Link to ='/Teoria-das-Cores'>
                            <button className='btn-Teoria-das-Cores'>
                                Teoria das Cores
                            </button>
                        </Link>
                    </div>
