        ...
        <Worker workerUrl="https://unpkg.com/pdfjs-dist@3.11.174/build/pdf.worker.min.js">
            <div style={{ display: 'flex', height: '150vh' }}>
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className='toolbar-container2' style={{ position: 'sticky', top: 0, zIndex: 100, backgroundColor: '#d9dfe2', width:'100%'}}>
                        <Toolbar>
                            {(props) => (
                                <div style={{
                                    display: 'flex', 
                    ...
                    <div className='Area-btn-SistemasMultimidia2'>
                        <Link to='/Teoria-das-Cores'>
                            <button className='btn-Teoria'>
                                Teoria das Cores
                            </button>
                        </Link>

                        <Link to ='/SistemasMultimidia'>
                            <button className='btn-Voltar-de-Teoria'>
                                Voltar
                            </button>
                        </Link> 

                        <Link to='/Midia-Estatica_Imagem'>
                            <button className='btn-Midia-Estatistica'>
                                Midia Estatica - Imagens
                            </button>
                        </Link>
                    </div>
                </div>
